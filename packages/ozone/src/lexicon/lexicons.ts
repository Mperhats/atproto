...
export const schemaDict = {
  ...
  AppBskyMerchantProfile: {
    ...
    defs: {
      main: {
        type: 'record',
        description: 'A declaration of a Bluesky merchant profile.',
        key: 'literal:self',
        record: {
          type: 'object',
          properties: {
            ...
            avatar: {
              type: 'blob',
              description:
                "Small image to be displayed next to posts from merchant. AKA, 'profile picture'",
              accept: ['image/png', 'image/jpeg'],
              maxSize: 1000000,
            },
            banner: {
            ...
            labels: {
              type: 'union',
              description:
                'Self-label values, specific to the Bluesky application, on the overall merchant.',
              refs: ['lex:com.atproto.label.defs#selfLabels'],
            },
          },
        },
